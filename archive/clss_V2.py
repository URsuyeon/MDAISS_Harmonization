...
class HospitalClassifier:
    ...
    def train(self, batch_size=8, num_epochs=50, learning_rate=0.001, weight_decay=1e-4):
        ...
        train_dataset = MedicalVolumeDataset(
            # csv_file=str(self.data_dir /'train_transformed.csv'),
            csv_file=str(self.data_dir /'train_sr_transformed.csv'),
        ...
        val_dataset = MedicalVolumeDataset(
            # csv_file=str(self.data_dir / 'val_transformed.csv'),
            csv_file=str(self.data_dir /'val_sr_transformed.csv'),
    ...
    def evaluate(self, model_path=None):
        ...
        test_dataset = MedicalVolumeDataset(
            # csv_file=str(self.data_dir / 'test_transformed.csv'),
            csv_file=str(self.data_dir /'test_sr_transformed.csv'),
...
def main():
    ...
    # model_dir = '/public/sylee/MDAISS_2/models/classifier/transformed/stargan3d_V2'
    data_dir = '/public/sylee/MDAISS_2/output/transformed/sr3d'
    model_dir = '/public/sylee/MDAISS_2/models/classifier/transformed/sr3d'
    # data_dir = '/public/sylee/MDAISS_2/output'
    # model_dir = '/public/sylee/MDAISS_2/models/classifier/original'
    # data_dir = '/public/sylee/MDAISS_2/output'
    # model_dir = '/public/sylee/MDAISS_2/models/classifier/original_256'
